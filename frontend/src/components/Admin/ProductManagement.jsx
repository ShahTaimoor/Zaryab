...
const ProductManagement = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 ">
      <h2 className="text-2xl font-bold mb-6">Product Mangment</h2>
          ...
          <tbody>
            {
              products.length > 0 ? (products.map((product) => (
                <tr key={product._id} className="border-b hover:bg-gray-50 cursor-pointer">
                  ...
                  <td className="p-4">
                    <Link to={`/admin/product/${product._id}`} className="bg-yellow-500 text-white py-1 px-2 rounded mr-2 hover:bg-yellow-600">
                      Edit</Link>
