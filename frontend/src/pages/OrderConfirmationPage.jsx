...
const OrderConfirmationPage = () => {
    ...
    if (!checkout) return <div>No order data found</div>;
            ...
            <div className="p-6 rounded-lg border">
                ...
                <div className="mb-20">
                    {checkout.checkoutItems.map((item) => (
                        <div className="flex items-center mb-4" key={`${item.productId}-${item.size}-${item.color}`}>
                            <img
                ...
                <div className="grid grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600">{checkout.shippingAddress?.address || 'N/A'}</p>
